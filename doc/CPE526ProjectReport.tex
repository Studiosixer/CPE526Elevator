...
Figue 4 shows the start of the synthesis demonstration with RST high. When RST is high the outputs door and direction are 1 and 00, respectively. 
...
FIgure 5 shows the transition to the Up1To2 state. The inputs F2 and DC are set high and the elevator transitions to the Up1To2 state. The inputs are latched meaning it is not required to keep F2 or DC high for the duration of the Up1To2 state. The outputs door and direction are 1 and 01, respectively. 
...
When the Floor Sensor (FS) inputs are 10 the elevator will transition to the OpenedDoors2 state and the outputs door and direction will be 0 and 00, respectively. It is not shown in figure 6 but the LED representing the door output actually went off for a few clock cycles. Once the input at floor 2 is recognized the door output of the elevator is high. 
...
Figure 7 shows the request on floor 2 to go to floor 3 and the outputs door and direction are 1 and 01, respectively. 
...
Figure 8 shows the final state of the elevator travelling from floor 3 down to floor 2. The outputs door and direction are 1 and 10, respectively, for this case.
